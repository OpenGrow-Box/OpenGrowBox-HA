...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    numbers = [
        ...
        CustomNumber(f"OGB_LuxToPPFDFactor_{coordinator.room_name}", coordinator.room_name, coordinator,
                    min_value=10.0, max_value=100.0, step=1, unit="X", initial_value=15.0),
        ...
        CustomNumber(f"OGB_Feed_Nutrient_A_{coordinator.room_name}", coordinator.room_name, coordinator,
                    min_value=0.0, max_value=500, step=0.1, unit="ml", initial_value=0), 
        ...
        CustomNumber(f"OGB_CropSteering_P0_MinEC_{coordinator.room_name}", coordinator.room_name, coordinator,
                    min_value=0.0, max_value=15, step=0.1, unit="ec", initial_value=0),
        CustomNumber(f"OGB_CropSteering_P0_VWC_Target_{coordinator.room_name}", coordinator.room_name, coordinator,
        ...
        CustomNumber(f"OGB_CropSteering_P1_MaxEC_{coordinator.room_name}", coordinator.room_name, coordinator,
                    min_value=0.0, max_value=15, step=0.1, unit="ec", initial_value=0),    
        CustomNumber(f"OGB_CropSteering_P1_VWC_Target_{coordinator.room_name}", coordinator.room_name, coordinator,
                    min_value=0.0, max_value=100, step=0.1, unit="%", initial_value=0),
        ...
        CustomNumber(f"OGB_CropSteering_P2_VWC_Target_{coordinator.room_name}", coordinator.room_name, coordinator,
                    min_value=0.0, max_value=100, step=0.1, unit="%", initial_value=0),    
        ...
        CustomNumber(f"OGB_CropSteering_P3_MaxEC_{coordinator.room_name}", coordinator.room_name, coordinator,
                    min_value=0.0, max_value=15, step=0.1, unit="ec", initial_value=0),    
        CustomNumber(f"OGB_CropSteering_P3_VWC_Target_{coordinator.room_name}", coordinator.room_name, coordinator,
                    min_value=0.0, max_value=100, step=0.1, unit="%", initial_value=0),        
