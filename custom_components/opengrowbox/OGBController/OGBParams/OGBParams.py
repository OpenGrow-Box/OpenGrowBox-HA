## INT DATA 
RELEVANT_PREFIXES = (
    "number.", "select.", "switch.", "light.", "time.", 
    "date.", "text.", "humidifier.", "fan.")
RELEVANT_KEYWORDS = (
    "_temperature", "_humidity", "_dewpoint", "_duty",
    "_voltage", "_co2","_carbondioxide","_lumen","_lux",
    "_illuminance" "_intensity","_moisture",
    "_ec","_ph","_conductivity","soil","water","medium,")
RELEVANT_TYPES = {
...
SENSOR_CONTEXTS = {
    ...
    "soil": {
        ...
        "icon": "mdi:flower",
        "suffixes": ["soil", "substrate", "ground", "boden", "erde", "substrat","coco","rockwoll","medium"]
    }
}
