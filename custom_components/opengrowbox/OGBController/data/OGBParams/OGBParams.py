...
DEVICE_TYPE_MAPPING = {
    ...
    "Pump": ["pump", "dripper", "feedsystem"],
    "FeedPump": ["feed_a", "feed_b", "feed_c", "feed_w", "feed_x", "feed_y", "feed_php", "feed_phm", "feed_water"],
    "ReservoirPump": ["reservoir_pump", "reservoirpump", "tank_fill", "fill_pump", "reservoir_fill", "water_fill"],
    "RetrievePump": ["retrieve", "return", "retrieve_pump", "return_pump", "recovery", "rücklauf", "ruecklauf"],
    "WateringPump": ["watering", "plant_water", "irrigation", "watering_pump", "irrigate", "bewässerung", "bewaesserung"],
